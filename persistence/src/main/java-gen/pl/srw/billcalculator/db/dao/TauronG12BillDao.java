...
public class TauronG12BillDao extends AbstractDao<TauronG12Bill, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TauronG12Bill entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(TauronG12Bill entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TauronG12Bill entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
