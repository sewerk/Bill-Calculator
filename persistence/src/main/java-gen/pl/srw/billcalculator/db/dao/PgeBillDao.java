...
public class PgeBillDao extends AbstractDao<PgeBill, Long> {
    ...
    */
    ...
    @Override
    protected void attachEntity(PgeBill entity) {
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM PGE_BILL T");
    ...
    protected PgeBill loadCurrentDeep(Cursor cursor, boolean lock) {
        PgeBill entity = loadCurrent(cursor, 0, lock);
    ...
    public PgeBill loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<PgeBill> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<PgeBill> list = new ArrayList<PgeBill>(count);
    ...
    protected List<PgeBill> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<PgeBill> queryDeep(String where, String... selectionArg) {
