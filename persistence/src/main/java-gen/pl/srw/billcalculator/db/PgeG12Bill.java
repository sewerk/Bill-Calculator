...
public class PgeG12Bill implements Bill {
    ...
    private PgeG12Prices pgeG12Prices;
    private Long pgeG12Prices__resolvedKey;
    ...
    public PgeG12Prices getPgeG12Prices() {
        Long __key = this.pricesId;
        if (pgeG12Prices__resolvedKey == null || !pgeG12Prices__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            PgeG12PricesDao targetDao = daoSession.getPgeG12PricesDao();
            PgeG12Prices pgeG12PricesNew = targetDao.load(__key);
            synchronized (this) {
                pgeG12Prices = pgeG12PricesNew;
            	pgeG12Prices__resolvedKey = __key;
            }
        }
        return pgeG12Prices;
    }

    public void setPgeG12Prices(PgeG12Prices pgeG12Prices) {
        synchronized (this) {
            this.pgeG12Prices = pgeG12Prices;
            pricesId = pgeG12Prices == null ? null : pgeG12Prices.getId();
            pgeG12Prices__resolvedKey = pricesId;
        }
    }
