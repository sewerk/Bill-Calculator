...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        TauronPricesDao.createTable(db, ifNotExists);
        TauronG11BillDao.createTable(db, ifNotExists);
        TauronG12BillDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        TauronPricesDao.dropTable(db, ifExists);
        TauronG11BillDao.dropTable(db, ifExists);
        TauronG12BillDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(TauronPricesDao.class);
        registerDaoClass(TauronG11BillDao.class);
        registerDaoClass(TauronG12BillDao.class);
