...
public class PgeG11BillDao extends AbstractDao<PgeG11Bill, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, PgeG11Bill entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(PgeG11Bill entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(PgeG11Bill entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
