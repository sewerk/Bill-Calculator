...
public class PgeG12BillDao extends AbstractDao<PgeG12Bill, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, PgeG12Bill entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, PgeG12Bill entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(PgeG12Bill entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(PgeG12Bill entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(PgeG12Bill entity) {
