...
public class TauronG11BillDao extends AbstractDao<TauronG11Bill, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, TauronG11Bill entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TauronG11Bill entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(TauronG11Bill entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TauronG11Bill entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(TauronG11Bill entity) {
