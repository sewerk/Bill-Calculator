...
public class TauronPricesDao extends AbstractDao<TauronPrices, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, TauronPrices entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TauronPrices entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(TauronPrices entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(TauronPrices entity) {
