...
public class PgnigBillDao extends AbstractDao<PgnigBill, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, PgnigBill entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(PgnigBill entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(PgnigBill entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
