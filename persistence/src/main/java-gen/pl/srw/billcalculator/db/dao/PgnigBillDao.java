...
/** 
 * DAO for table "PGNIG_BILL".
*/
@SuppressWarnings("ALL")
public class PgnigBillDao extends AbstractDao<PgnigBill, Long> {

    public static final String TABLENAME = "PGNIG_BILL";

    /**
     * Properties of entity PgnigBill.<br/>
    ...
    public PgnigBillDao(DaoConfig config) {
        super(config);
    }
    
    public PgnigBillDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PGNIG_BILL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PGNIG_BILL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, PgnigBill entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, PgnigBill entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(PgnigBill entity) {
    ...
    @Override
    public PgnigBill readEntity(Cursor cursor, int offset) {
        PgnigBill entity = new PgnigBill( //
    ...
    @Override
    public void readEntity(Cursor cursor, PgnigBill entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(PgnigBill entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(PgnigBill entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(PgnigBill entity) {
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getPgnigPricesDao().getAllColumns());
            builder.append(" FROM PGNIG_BILL T");
            builder.append(" LEFT JOIN PGNIG_PRICES T0 ON T.\"PRICES_ID\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected PgnigBill loadCurrentDeep(Cursor cursor, boolean lock) {
        PgnigBill entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        PgnigPrices pgnigPrices = loadCurrentOther(daoSession.getPgnigPricesDao(), cursor, offset);
        entity.setPgnigPrices(pgnigPrices);

        return entity;    
    }

    public PgnigBill loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<PgnigBill> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<PgnigBill> list = new ArrayList<PgnigBill>(count);
    ...
    protected List<PgnigBill> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<PgnigBill> queryDeep(String where, String... selectionArg) {
